...
public class ImageGeneratorTESTVIDEO2K {
...
绘制图片的时候坐标
        ...
        */
        ...
        //1、图片4k分辨率
        int widthX = 1440; // 图片宽度
        int heightY = 2560; // 图片高度
        //8K分辨率
//        int width = 4320; // 图片宽度
...
//        String ttfPath = "A:/夸克下载/免费商用字体/字体/2/milky-mono-cn-extralight.ttf";
        ...
        Font font = null;
        font = new Font("宋体", Font.PLAIN, 39); // 可更改的字体和大小变量
//        try {
...
//        g2d.drawString(sourceAndAuthor, XX, A1Y + Y6); // 绘制出处和作者
        ...
        String biaoti="轻舟已过万重山";
        int sourceAndAuthorWidth1 = autorFm.stringWidth(biaoti);
        int qq = (widthX - sourceAndAuthorWidth1) / 2;
        g2d.drawString(biaoti, qq, Y1 + Y4/2); // 绘制出处和作者
    ...
    /*    try {
        ...
        try {
            ImageIO.write(image, "png", new File("A:/Users/123/Desktop/图片测试/2K.png")); // 输出图片到文件
        } catch (IOException e) {
            e.printStackTrace();
        }
