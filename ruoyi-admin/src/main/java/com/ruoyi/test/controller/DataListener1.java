...
@Slf4j
@Data
public class DataListener1 implements ReadListener<Sheet1> {

    List<Sheet1> sheet1DataList = new ArrayList<>();
    public DataListener1(List<Sheet1> sheet1DataList) {
...
//这个每一条数据解析都会来调用
    ...
    @Override
    public void invoke(Sheet1 data, AnalysisContext context) {
    ...
    public void doAfterAllAnalysed(AnalysisContext context) {
      ...
      public List<Sheet1> getAllSheetData() {
