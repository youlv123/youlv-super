...
@Slf4j
@Data
public class DataListener3 implements ReadListener<Sheet3> {

    List<Sheet3> sheet1DataList = new ArrayList<>();
    public DataListener3(List<Sheet3> sheet1DataList) {
...
//这个每一条数据解析都会来调用
    ...
    @Override
    public void invoke(Sheet3 data, AnalysisContext context) {
    ...
    public void doAfterAllAnalysed(AnalysisContext context) {
      ...
      public List<Sheet3> getAllSheetData() {
