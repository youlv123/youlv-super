<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否绑定产生的分类" prop="qrcodeCategoryFlag">
        <el-select v-model="queryParams.qrcodeCategoryFlag" placeholder="请选择是否绑定产生的分类" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="categoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="主键ID" align="center" prop="categoryId" />
      ...
      <el-table-column label="是否绑定产生的分类" align="center" prop="qrcodeCategoryFlag">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_yes_no" :value="scope.row.qrcodeCategoryFlag"/>
        </template>
      </el-table-column>
